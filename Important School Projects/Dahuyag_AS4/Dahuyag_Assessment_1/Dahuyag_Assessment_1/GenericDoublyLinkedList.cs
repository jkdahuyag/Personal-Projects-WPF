...
{
    public class GenericDoublyLinkedList<T> : ILinkedList<T>, IEnumerable<T>, IComparable<GenericDoublyLinkedList<T>>
    {
        ...
        public void Remove(int position)
        {
            ...
            //if (tmp == Head && Head.Next != null) Head = Head.Next;
            //if (tmp == Tail && Tail.Prev != null) Tail = Tail.Prev;
        ...
        public int CompareTo(GenericDoublyLinkedList<T> other)
        {
            if (Count != other.Count) return 1;
            
            var tmp = Head;
            var otherTmp = other.Head;
            while (tmp != null)
            {

                if (Comparer<T>.Default.Compare(tmp.Data, otherTmp.Data)!=0) return 1;
                tmp = tmp.Next;
